...
public class DeleteTemplate {
    public static void main(String[] args) {
        ...
        StructureTemplate dataToSend = new StructureTemplate("d0035f81c21440ffb892e446ca99486f", "sampleText");
        try {
            delete(url, dataToSend);
    ...
    public static void delete(String url, ValidStructure structureTemplate) throws URISyntaxException{
        ...
        try{
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                ValidDeleteResponse responseEntity = objectMapper.readValue(response.toString(), structureTemplate.validDeleteResponseType());
